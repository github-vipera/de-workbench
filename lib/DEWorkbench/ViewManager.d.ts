...
export declare class ViewManager {
    ...
    protected manageURI(uri: string, params: any): ProjectSettingsView | PushToolView | LoggerView | BookmarksView | ServersView | ServerInstanceConfigurationView | DebugAreaView | DebugBreakpointsView | DebugCallStackView | DebugVariablesView | DebugWatchExpressionsView;
