...
export declare class FileTailLogModel extends BaseLogModel {
    private filePath;
    private events;
    private tail;
    constructor(filePath: string, lastLine?: number);
    private createAndAddLogLine(data);
    private createLogLine(data);
    private cleanMessage(msg);
    private convertToLogLevel(logLevelStr);
...
export declare class UILogView extends UIBaseComponent implements LogModelListener {
    ...
    private createLogLineElement(logLine, className?);
}
export declare class UILoggerComponent extends UIBaseComponent {
    ...
    addLog(message: string, level?: LogLevel, timestamp?: string): UILoggerComponent;
